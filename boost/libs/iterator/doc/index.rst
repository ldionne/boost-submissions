...
* |transform_output|_ (PDF__): an output iterator applying a functional
  transformation to the value assigned to it before performing the output
  operation. Implements a "pipeline of operations".
...
.. |transform_output| replace:: ``transform_output_iterator``
.. _transform_output: transform_output_iterator.html
__ transform_output_iterator.pdf
